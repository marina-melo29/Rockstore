...
class ShirtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shirt" do
    assert_difference('Shirt.count') do
      post shirts_url, params: { shirt: { color: @shirt.color, price: @shirt.price, title: @shirt.title } }
    end
  ...
  test "should update shirt" do
    patch shirt_url(@shirt), params: { shirt: { color: @shirt.color, price: @shirt.price, title: @shirt.title } }
